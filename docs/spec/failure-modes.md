...
| Backend has no ready endpoints | Return the Gateway API/conformance-required unavailable response (HTTP, or the equivalent gRPC status), or refuse the connection (TCP and TLS passthrough); keep watching EndpointSlices |
