...
| Backend has no ready endpoints | Return the Gateway API/conformance-required unavailable response (HTTP), or refuse the connection (TCP and TLS passthrough); keep watching EndpointSlices |
